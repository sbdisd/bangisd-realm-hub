      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          <div className="mb-8">
            <img
              src={bangIsdAvatar}
              alt="Bang Isd"
              className="w-32 h-32 rounded-full mx-auto shadow-[var(--shadow-glow)] border-4 border-accent/30"
            />
          </div>
          ...
          {socialLinks.map((social) => {
            ...
            return (
              <a
                key={social.name}
                href={social.url}
                className="glass-panel p-6 text-center hover:scale-105 transition-transform duration-300 group"
              >
        ...
        <div className="glass-panel p-8 mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-secondary/20 rounded-lg aspect-video flex items-center justify-center border border-accent/20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="glass-panel p-6 text-center">
            <div className="text-2xl font-bold text-peach mb-2">350+</div>
          ...
          <div className="glass-panel p-6 text-center">
            <div className="text-2xl font-bold text-peach mb-2">24/7</div>
