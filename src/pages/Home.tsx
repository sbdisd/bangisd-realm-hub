...
const Home = () => {
  ...
  // Kunci API dan ID Channel Anda telah dimasukkan
  const YOUTUBE_API_KEY = "AIzaSyDn8rDHnqMjX-9mo-lkCEvwLewL2v7Sfa4";
  const YOUTUBE_CHANNEL_ID = "UC1JoEzzcJG48seclqxIgoqw";
    ...
    <div className="min-h-screen">
      ...
      >
        <div className="container mx-auto px-4 text-center z-10">
          ...
          {/* Latest Video Embed */}
          <div className="mt-16">
            <div className="w-full max-w-2xl aspect-video bg-secondary/20 rounded-lg border-2 border-accent/20 glass-panel overflow-hidden mx-auto">
              {isLoading ? (
